    ...
    >
      <header className="flex items-center gap-3">
        <div className="size-8 p-1.5 bg-[#1c2534] rounded-2xl flex justify-center items-center">
          <img src="/icons/icon_road.png" alt="Road icon" className="size-[18px]" />
        </div>
        <h2 className="text-black text-sm font-semibold">Road Condition Overview</h2>
      </header>

      <section>
        <h3 className="text-xs text-black font-semibold mb-2">Road Segment Summary</h3>
      ...
      <div className="grid grid-cols-2">
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="text-center -mt-6">
            <div className="text-[42px] font-bold text-[#F97316]">{score}</div>
            <p className="text-sm font-medium text-[#F97316]">Moderate Risk</p>
          </div>
        </div>
