                ...
                <div data-layer="content_container" className="ContentContainer size- flex flex-col justify-start items-start gap-[18px]">
                    <div data-layer="info_rows" className="InfoRows w-[205px] h-[92px] inline-flex justify-between items-center">
                        ...
                        <div data-layer="value_container" className="ValueContainer w-[9px] h-[91px] inline-flex flex-col justify-center items-end gap-5">
                            <div data-layer="vessels_loading" className="VesselsLoading text-right justify-start text-black text-sm font-semibold">{data.vesselsLoading}</div>
                            <div data-layer="vessels_waiting" className="VesselsWaiting text-right justify-start text-black text-sm font-semibold">{data.vesselsWaiting}</div>
                            <div data-layer="vessels_non_delay_risk" className="VesselsNonDelayRisk text-right justify-start text-[#4caf50] text-sm font-semibold">{data.vesselsNonDelayRisk}</div>
                        </div>
                    </div>
                    ...
                    <div data-layer="footer_container" className="FooterContainer w-[205px] h-[17px] inline-flex justify-between items-start">
                        ...
                        <div data-layer="vessel_name" className="VesselName w-[118px] text-right justify-start text-black/60 text-sm font-semibold">{data.vesselName}</div>
                    </div>
                </div>
            </div>
        </div>
