                ...
                <div data-layer="content_container" className="ContentContainer self-stretch flex flex-col justify-start items-start gap-[15px]">
                    <div data-layer="info_rows" className="InfoRows self-stretch inline-flex justify-between items-center">
                        ...
                        <div data-layer="value_container" className="ValueContainer w-[9px] inline-flex flex-col justify-start items-end gap-3">
                            <div data-layer="rain_prob_pct" className="RainProbPct text-right justify-start text-black text-sm font-semibold">{data.rainProbPct}</div>
                            <div data-layer="wind_speed_mps" className="WindSpeedMps text-right justify-start text-black text-sm font-semibold">{data.windSpeedMps}</div>
                            <div data-layer="visibility_km" className="VisibilityKm text-right justify-start text-black text-sm font-semibold">{data.visibilityKm}</div>
                            <div data-layer="extreme_flag" className="ExtremeFlag text-right justify-start text-black text-sm font-semibold">{data.extremeFlag}</div>
                        </div>
                    </div>
