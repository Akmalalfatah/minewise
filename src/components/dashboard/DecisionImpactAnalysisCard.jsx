...
function DecisionImpactAnalysisCard({ data }) {
  ...
  const mapped = [
    {
      ...
      value: data.correlation?.rain_vs_production ?? 0
    },
    {
      label: "Visibility vs Loading",
      value: data.correlation?.visibility_vs_loading ?? 0
    }
  ];
  ...
  return (
    <section
      ...
      className="DecisionImpactAnalysisCard w-full h-full p-6 bg-white rounded-3xl flex gap-8"
    >
