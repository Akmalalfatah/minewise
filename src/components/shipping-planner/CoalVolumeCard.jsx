...
function CoalVolumeCard() {
    ...
    return (
        <section
            ...
            className="CoalVolumeCard w-full p-6 bg-white rounded-3xl flex flex-col items-center gap-2.5 h-full"
        >
                        ...
                        (sp, idx) => (
                            ...
                            >
                                <div className="CoalCardHeaderWrapper self-stretch h-[196px] flex flex-col justify-center items-start gap-7">
                                    ...
                                    <section className="CoalCardContentContainer self-stretch h-[160px] flex flex-col justify-center items-start gap-3">
