...
import { getExportTemplates } from "../../services/reportsService";
            ...
            <div className="self-stretch h-72 flex flex-col justify-start items-start gap-5">
                ...
                <div className="inline-flex justify-start items-center gap-3">
                    <div className="w-8 h-8 p-1.5 bg-gray-800 rounded-2xl flex justify-center items-center">
                        <img className="w-4 h-4" src="src/icons/icon_export.png" />
                    </div>
                ...
                <div className="self-stretch flex flex-col justify-center items-start gap-4">
                    ...
                    <div className="self-stretch flex flex-col justify-start items-start gap-3.5">
                        ...
                        {data.templates.map((t, index) => (
                            <div key={index} className="self-stretch h-14 px-6 py-4 bg-white rounded-xl outline outline-1 outline-slate-300 flex flex-col justify-center">
                                <div className="inline-flex justify-start items-center gap-3">
                                    <img className="w-4 h-4" src="src/icons/file_icon.png" />
                                    <div className="text-black text-sm font-semibold font-['Inter']">
                                        {t}
                                    </div>
                                </div>
