...
function MineRoadSegmentTable() {
  ...
  const segments = useMemo(() => {
    ...
    // CASE: backend ngirim object tunggal
    const asSingleObject =
      rawSegments === null &&
      (data?.segment_name || data?.road_condition_label || data?.travel_time);

    const list = rawSegments ?? (asSingleObject ? [data] : []);

    return list.map((s) => {
      const segment_name = pick(
        s,
      ...
      return {
        ...
        travel_time: pick(
          s,
          ["travel_time", "travelTime", "travel_time_min", "travelTimeMin"],
          null
        ),
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* kalau segments kosong, hint buat debug */}
            {segments.length === 0 && (
        ...
        >
          <h3 className="self-stretch text-black text-sm font-semibold">
            Speed Information
          </h3>
          ...
          <div className="self-stretch inline-flex justify-between items-center">
            ...
            <div className="w-24 inline-flex flex-col justify-start items-end gap-[11px]">
              <p className="text-[#666666] text-xs font-semibold text-right">
                Actual Speed
              </p>
          ...
          >
            <div className="w-[277px] inline-flex flex-col justify-start items-start gap-1">
              <p className="text-[#8f0b09] text-sm font-semibold">
                {alert.title}
              </p>
