        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <li>
                            <KpiCardWrapper className="ExcellentStatusCardContainer w-[133px] h-14 px-[13px] py-1 bg-[#4caf50] rounded-[10px] inline-flex flex-col justify-center items-center">
                        ...
                        <li>
                            <KpiCardWrapper
                                ...
                                className="SeverelyDamagedStatusCardContainer w-[120px] h-14 px-1.5 py-[7px] bg-[#c30012] rounded-[10px] flex flex-col justify-center items-center"
                            >
                                <p className="text-white text-[10px] font-bold">
                                    Severely Damaged
                                </p>
