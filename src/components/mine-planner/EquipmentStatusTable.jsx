      ...
      >
        ...
        >
          <div
            ...
            className="EquipmentTableContainer w-full inline-flex justify-start items-start gap-[15px] max-h-[260px] overflow-y-auto pr-2"
          >
            ...
            {fleetOverview.map((fleet, i) => (
              ...
              >
                ...
                <div className="text-black text-xs">
                  ...
                  active
                  <br />
                  <AnimatedNumber value={fleet.maintenance ?? 0} decimals={0} />{" "}
                  maintenance
                  <br />
